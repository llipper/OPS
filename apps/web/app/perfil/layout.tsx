...
import { User, Users, Shield, MapPin, ShoppingBag, HeadphonesIcon } from "lucide-react"
...
export default function PerfilLayout({ children }: { children: React.ReactNode }) {
  ...
  const activeTab =
    TABS.find((t) => pathname === t.href || (t.href !== "/perfil" && pathname.startsWith(t.href)))?.href ?? "/perfil"
      ...
      <div className="flex-1 flex flex-col p-8 pt-6 gap-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Gerencie suas informações pessoais, endereços, segurança e muito mais.
          </p>
        </div>
