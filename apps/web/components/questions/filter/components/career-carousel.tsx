                ...
                >
                    {items.map((concurso) => {
                        ...
                        return (
                            ...
                            >
                                <div className={`relative w-14 h-14 rounded-2xl mb-2 transition-all overflow-hidden border flex items-center justify-center ${isActive ? "bg-primary/5 border-primary/20 scale-110" : "bg-muted/5 border-border/10"}`}>
                                    {concurso.logoUrl ? (
                                        <Image src={concurso.logoUrl} alt={concurso.name} fill sizes="56px" className="object-cover" />
                                    ) : (
