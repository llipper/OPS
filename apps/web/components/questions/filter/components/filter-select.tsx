        ...
        <div className="space-y-1.5 w-full">
            ...
            <Combobox onOpenChange={(open) => {
                ...
                <ComboboxInput
                    ...
                    showClear={false}
                    disabled={disabled}
                    className="[&_input]:truncate [&_input]:text-ellipsis [&_input]:overflow-hidden"
                />
                        ...
                        {filteredOptions.map((opt) => {
                            ...
                            return (
                                <div
                                    ...
                                    className="flex min-w-0 overflow-hidden items-center gap-2.5 px-2 py-1.5 rounded-sm text-sm cursor-pointer hover:bg-accent hover:text-accent-foreground transition-colors"
                                >
                                    ...
                                    <span title={opt.label} className={`min-w-0 truncate ${isChecked ? "font-medium" : "text-muted-foreground"}`}>
                                        {opt.label}
                                    </span>
                                </div>
                            )
